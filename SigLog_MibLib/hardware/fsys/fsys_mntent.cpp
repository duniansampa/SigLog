...
#include "mnttypes.h"
    ...
    else if ( !strcmp(tpname, MNTTYPE_PC) ||
              !strcmp(tpname, MNTTYPE_MSDOS) )
    ...
    else if ( !strcmp(tpname, MNTTYPE_ISO9660) ||
              !strcmp(tpname, MNTTYPE_CD9660) )
    ...
    else if ( !strcmp(tpname, MNTTYPE_NFS)  ||
              !strcmp(tpname, MNTTYPE_NFS3) ||
              !strcmp(tpname, MNTTYPE_NFS4) ||
              !strcmp(tpname, MNTTYPE_CIFS) ||  /* i.e. SMB - ?? */
    ...
    else if ( !strcmp(tpname, MNTTYPE_EXT2) ||
              !strcmp(tpname, MNTTYPE_EXT3) ||
              !strcmp(tpname, MNTTYPE_EXT4) ||
              !strcmp(tpname, MNTTYPE_EXT2FS) ||
              !strcmp(tpname, MNTTYPE_EXT3FS) ||
              !strcmp(tpname, MNTTYPE_EXT4FS) )
       return NETSNMP_FS_TYPE_EXT2;
    else if ( !strcmp(tpname, MNTTYPE_FAT32) ||
              !strcmp(tpname, MNTTYPE_VFAT) )
     ...
     */
    else if ( !strcmp(tpname, MNTTYPE_MVFS) ||
              !strcmp(tpname, MNTTYPE_TMPFS) ||
              !strcmp(tpname, MNTTYPE_GFS) ||
              !strcmp(tpname, MNTTYPE_GFS2) ||
              !strcmp(tpname, MNTTYPE_XFS) ||
              !strcmp(tpname, MNTTYPE_JFS) ||
              !strcmp(tpname, MNTTYPE_VXFS) ||
              !strcmp(tpname, MNTTYPE_REISERFS) ||
              !strcmp(tpname, MNTTYPE_OCFS2) ||
              !strcmp(tpname, MNTTYPE_CVFS) ||
              !strcmp(tpname, MNTTYPE_SIMFS) ||
              !strcmp(tpname, MNTTYPE_BTRFS) ||
              !strcmp(tpname, MNTTYPE_ZFS) ||
              !strcmp(tpname, MNTTYPE_ACFS) ||
              !strcmp(tpname, MNTTYPE_LOFS))
